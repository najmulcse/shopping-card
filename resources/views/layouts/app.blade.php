    ...
    <div class="header-top">
        ...
        <div class="col-sm-4 world">
            ...
            <div class="col-sm-4 header-left">  
             ...
             @if (Auth::guest())  
                    <p class="log"><a href="{{url('/login')}}"  >Login</a>
                    <span>or</span><a  href="{{url('register')}}"  >Signup</a></p>
            @else
                        <li class="dropdown">
                    ...
                    <div class="cart box_1">
                      <ul>
                        <a href="{{route('shoppingCart')}}" class="btn btn-primary">
                            ...
                            Shopping Cart
                            <span class="badge"> {{Session::has('cart') ? Session::get('cart')->totalQuantity : 'Empty Cart'}}</span>
