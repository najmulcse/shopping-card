...
<div class="col-md-9">
	<div class="col-md-5 grid">		
		<div class="flexslider">
			  <ul class="slides">
			    <li data-thumb="{{asset(''.$id->photo)}}">
			        <div class="thumb-image"> <img src="{{asset(''.$id->photo)}}" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
			    ...
			    </li> <li data-thumb="{{asset('images/si1.jpg')}}">
			         <div class="thumb-image"> <img src="{{asset('images/si1.jpg')}}" data-imagezoom="true" class="img-responsive"> </div>
			    </li>
